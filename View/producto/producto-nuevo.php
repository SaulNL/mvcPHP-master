...
<form id="frm-producto" action="?c=producto&a=Guardar" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <input type="text" name="nit" value="<?php echo $prod->nit; ?>" class="form-control" placeholder="Ingrese Tipo producto" data-validacion-tipo="requerido|min:20" />
    </div>
    ...
    <div class="form-group">
        ...
        <input type="text" name="precioU" value="<?php echo $prod->precioU; ?>" class="form-control" placeholder="Ingrese Cantidad" data-validacion-tipo="requerido|min:20" />
    </div>
